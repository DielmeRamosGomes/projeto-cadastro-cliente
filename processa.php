...
if (!isset($_POST['nomeUsuario']) || !isset($_POST['senhaUsuario']) || !isset($_POST['dataNascimento']) || !isset($_POST['cpfUsuario']) || !isset($_POST['rgUsuario'])){
...
$sql = "CALL cadastroUsuario('$nomeUsuario','$senhaUsuario','$dataNascimento','$cpfUsuario','$rgUsuario');" ;
